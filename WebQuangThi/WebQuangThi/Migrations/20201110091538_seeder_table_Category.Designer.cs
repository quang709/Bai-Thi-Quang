...
namespace WebQuangThi.Migrations
{
    ...
    [Migration("20201110091538_seeder_table_Category")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebQuangThi.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebQuangThi.Models.Posts", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebQuangThi.Models.Posts", b =>
                {
                    b.HasOne("WebQuangThi.Models.Category", "Category")
                        .WithMany("Posts")
